...
- **重复类型**：支持每天、工作日、自定义、指定日期四种重复方式
- **每日自动重置**：重复类型待办完成后，过 0 点自动重置为未完成
- **快速创建**：添加页面一键切换「打卡提醒 / 待办事项」
- **自动排序**：按日期+时间从早到晚排序，已完成排最后
...
CREATE TABLE reminders (
  ...
  completedDate INTEGER,         -- 完成时间（毫秒时间戳），用于每日自动重置
